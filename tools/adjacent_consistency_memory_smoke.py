...
def command_smoke(args: argparse.Namespace) -> int:
    ...
    canonical = tensor_state_sha256(model.state_dict())
    if canonical != pilot.PARENT_CANONICAL_MODEL_STATE_SHA256:
        raise pilot.ACDPilotError("memory smoke canonical parent state differs")
    del snapshot
