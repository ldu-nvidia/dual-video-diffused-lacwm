"""Dedicated Hydra entrypoint for CAMP planner and video stages."""
...
def _teardown(trainer: Trainer) -> None:
    failures = []
...
def _setup(cfg: DictConfig) -> Trainer:
    ...
    try:
        ...
        if not isinstance(trainer, Trainer):
            raise RuntimeError("CAMP entrypoint requires a Trainer instance")
        ...
        if trainer is not None:
            try:
                ...
                logger.error("CAMP teardown failed during setup failure", exc_info=True)
        raise
...
def main(cfg: DictConfig) -> None:
    ...
    try:
        ...
        try:
            ...
            logger.error("CAMP teardown also failed", exc_info=True)
        raise
    else:
        _teardown(trainer)
