# Copied from https://github.com/UT-Austin-RPL/deoxys_control
# License information: https://github.com/UT-Austin-RPL/deoxys_control/blob/main/LICENSE
"""
...
def pose_in_A_to_pose_in_B(pose_A, pose_A_in_B):
    """
    Converts a homogeneous matrix corresponding to a point C in frame A
    to a homogeneous matrix corresponding to the same point C in frame B.
...
def get_pose_error(target_pose, current_pose):
    ...
    Args:
        target_pose (np.array): a 4x4 homogeneous matrix for the target pose
        current_pose (np.array): a 4x4 homogeneous matrix for the current pose
